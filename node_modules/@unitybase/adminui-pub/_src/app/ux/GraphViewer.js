...
/* global Ext, UB, mxUtils, mxEditor, mxRubberband, mxCodec */
/**
 * Workflow Diagram
 */
Ext.define('UB.ux.GraphViewer', {
  ...
  initMXEditor: function () {
    ...
    var me = this; var editor; var graph
  ...
  onEndEdit: function (isChanged, data) {
    var params; var me = this

    var mainPnl; var docContainer; var document; var baseDoc
